...
theme.wallpaper                                 = theme.dir .. "/nebula.jpg"
theme.font                                      = "hack 12"
theme.fg_normal                                 = "#BBBBBB" -- "#d8dee9" --
...
-- Calendar
local mytextcal = wibox.widget.textclock("<span font='Terminus 5'> </span>%d.%m.%Y")
...
function theme.at_screen_connect(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, height = dpi(18), bg = theme.bg_normal, fg = theme.fg_normal, border_width = dpi(5), border_color = theme.bg_normal})
